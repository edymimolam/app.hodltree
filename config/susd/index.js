import {
    EM_POOL_ABI, EM_POOL_ADDRESS_MAINNET, EM_POOL_ADDRESS_KOVAN
  } from "./contracts/em-pool"
  import {
    RESERVE_POOL_ABI, RESERVE_POOL_ADDRESS_MAINNET, RESERVE_POOL_ADDRESS_KOVAN
  } from "./contracts/reserve-pool"
  import {
    VOLATILE_POOL_ABI, VOLATILE_POOL_ADDRESS_MAINNET, VOLATILE_POOL_ADDRESS_KOVAN
  } from "./contracts/volatile-pool"
  import {
    VP_STORAGE_ABI, VP_STORAGE_ADDRESS_MAINNET, VP_STORAGE_ADDRESS_KOVAN
  } from "./contracts/vp-storage"
  import {
    INPUT_TOKEN_ADDRESS_MAINNET, EPT_ADDRESS_MAINNET, VPT_ADDRESS_MAINNET, BPT_ADDRESS_MAINNET,
    INPUT_TOKEN_ADDRESS_KOVAN, EPT_ADDRESS_KOVAN, VPT_ADDRESS_KOVAN, BPT_ADDRESS_KOVAN,
    IERC20_ABI,
  } from "./tokens"
  
  const generalConfig = {
    headerText: {
      title: "sUSD Elastic Module (Beta)",
      annotation: "This module is in beta. Use at your own risk"
    },
    elasticTitle: "EM-Synthetix pool",
    balancerPoolTitle: "Balancer (sUSD/sETH 75/25)",
    balancerCounterCurrencyTicker: "sETH",
    inputTokenTicker: "sUSD",
    vptTicker: "VPT",
    eptTicker: "EPT",
    bptTicker: "BPT",
    eptPercentage: "50",
  ...
  export const config = process.env.NEXT_PUBLIC_ENVIRONMENT === 'DEV'
